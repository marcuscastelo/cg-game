...
class Asteroids(Element):
    asteroids_size: float = 0.02
    rotation_speed: float = 0.1

    def _create_vertex_buffer(self) -> VertexSpecification:
        return VertexSpecification([
            Vertex(Vec3(0, self.asteroids_size, 0.0)),
            Vertex(Vec3(-self.asteroids_size*0.58, -self.asteroids_size*0.81, 0.0)),
            Vertex(Vec3(self.asteroids_size*0.36, -self.asteroids_size*0.12, 0.0)),

            Vertex(Vec3(-self.asteroids_size*0.58, -self.asteroids_size*0.81, 0.0)),
            Vertex(Vec3(self.asteroids_size*0.95, self.asteroids_size*0.31, 0.0)),
            Vertex(Vec3(-self.asteroids_size*0.22, self.asteroids_size*0.31, 0.0)),
